    ...
    return (
        ...
        <Layout>
            ...
            <div className=" links flex">
                <Link className={modalActive ? "opacity-0" : "ml-2 block uppercase spisok"} to="/projects">Список
                    проектов </Link>
                <Link className={modalActive ? "opacity-0" : "ml-4 block   uppercase spisok"} to="/projects">Дорожные
                    карты </Link>
            </div>
     ...
     bg-fuchsia-600 focus:outline-none focus:border-red-700 focus:ring
           focus:ring-red-200 disabled:opacity-25 transition blok"
            ...
            <div className="flex justify-end items-center pagination mb-4">
                <NavLink to="/projects" onClick={() => setPagination(true)}
                ...
                <NavLink to="/projects" onClick={() => setPagination(false)}
                         className="cursor-pointer hover:text-purple-800"><i
            ...
            <div className={pagination ? "ml-7 row pl-3 pr-3 " : null}>
                {
                    project.map((project) => (
                        <div key={project.id}
                             className={pagination ? "col-3 mb-3" : " w-full flex items-center justify-between "}>
                            <div
                                className="
        c-card
        block
