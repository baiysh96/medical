...
const Login = () => {
    ...
    return (
        <div>
            <div
                className="bg-white w-full min-h-screen overflow-hidden  bg-gray-50ex flex-col sm:justify-center items-center pt-6 sm:pt-0">
                <div className="w-full sm:max-w-md  mx-auto">
                    <Link className="block ml-auto" to="/"><img className="block mx-auto mb-6 mt-2" src={logo}
                                                                width="200px" height="100px" alt="logo"/></Link>
                    <div className="mb-4">
